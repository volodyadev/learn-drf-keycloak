...
from users.views import (AdminOnlyView, CustomAdminOnlyView, CustomLoginView,
                         CustomPublicView, CustomRegisterView,
                         CustomUserOnlyView, PublicView, RegisterUserView,
                         UserView)
